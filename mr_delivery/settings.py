...
APP_STATUS_UPDATE_ENABLED = _env_bool(
    "APP_STATUS_UPDATE_ENABLED",
    default=APP_STATUS_FORCE_UPDATE_ENABLED,
)
APP_STATUS_UPDATE_FORCE_UPDATE = _env_bool(
    "APP_STATUS_UPDATE_FORCE_UPDATE",
    default=APP_STATUS_FORCE_UPDATE_ENABLED,
)
APP_STATUS_ANDROID_MIN_VERSION = os.environ.get(
    "APP_STATUS_ANDROID_MIN_VERSION",
    APP_STATUS_FORCE_UPDATE_REQUIRED_VERSION,
).strip()
APP_STATUS_ANDROID_STORE_URL = os.environ.get(
    "APP_STATUS_ANDROID_STORE_URL",
    "",
).strip()
APP_STATUS_IOS_MIN_VERSION = os.environ.get(
    "APP_STATUS_IOS_MIN_VERSION",
    APP_STATUS_FORCE_UPDATE_REQUIRED_VERSION,
).strip()
APP_STATUS_IOS_STORE_URL = os.environ.get(
    "APP_STATUS_IOS_STORE_URL",
    "",
).strip()
APP_STATUS_WINDOWS_MIN_VERSION = os.environ.get(
    "APP_STATUS_WINDOWS_MIN_VERSION",
    APP_STATUS_FORCE_UPDATE_REQUIRED_VERSION,
).strip()
APP_STATUS_WINDOWS_DOWNLOAD_URL = os.environ.get(
    "APP_STATUS_WINDOWS_DOWNLOAD_URL",
    "",
).strip()
